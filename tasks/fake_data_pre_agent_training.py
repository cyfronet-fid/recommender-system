...
if __name__ == "__main__":
    connection = connect(host=TestingConfig.MONGODB_HOST)

    # Populate database with artificial data
    print("Populating database with artificial data...")

    no_one_services = [ServiceFactory() for _ in range(20)]
    ...
    user2.save()
    print("Database populated with artificial data successfully!\n")
    ...
    # Transformers are automaticaly saved after transforming raw dataset to tensors
    # But you can also save them manually in following way:
    # print("Transformers saving...")
