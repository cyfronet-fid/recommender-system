...
def _synthesize_user(
    ...
    niche_range: Tuple[int, int] = (5, 7), # TODO: should be (1, 2) if we want to have cartesian product working
) -> User:
...
def synthesize_users(
    ...
    transformer = precalculate_tensors(users, transformer, save=False)
    save_transformer(transformer, SYNTHETIC_USERS)
