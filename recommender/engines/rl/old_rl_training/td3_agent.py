...
#
#         common_critic_history_embedder_1 = MLPHistoryEmbedder(SE=SE,
#                                                               max_N=N)  #  TODO: proper history embedder loading from database
#         common_critic_history_embedder_2 = MLPHistoryEmbedder(SE=SE,
#                                                               max_N=N)  # TODO: proper history embedder loading from database
#
#         # Critic 1
#         self.Q1_Φ = Critic(
