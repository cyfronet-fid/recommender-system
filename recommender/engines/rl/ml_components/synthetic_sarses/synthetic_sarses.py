...
from recommender.engines.rl.ml_components.synthetic_sarses.service_engagement import (
...
def generate_synthetic_sarses(
    ...
    It takes all existing users and for each one generates
    specified number of SARSes by:
