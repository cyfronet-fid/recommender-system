...
def test_recommendation_deserialization(mongo, recommendation_json_dict):
    ...
    assert r.visit_id == recommendation_json_dict.get("visit_id")
...
def test_user_action_deserialization(mongo, user_action_json_dict):
    ...
    assert ua.source.visit_id == user_action_json_dict.get("source").get("visit_id")
    ...
    assert ua.target.visit_id == user_action_json_dict.get("target").get("visit_id")
